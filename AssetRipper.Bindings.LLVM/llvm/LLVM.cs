...
public static unsafe partial class LLVM
{
    ...
    public const int LLVMFastMathAllowReassoc = (1 << 0);
    public const int LLVMFastMathNoNaNs = (1 << 1);
    public const int LLVMFastMathNoInfs = (1 << 2);
    public const int LLVMFastMathNoSignedZeros = (1 << 3);
    public const int LLVMFastMathAllowReciprocal = (1 << 4);
    public const int LLVMFastMathAllowContract = (1 << 5);
    public const int LLVMFastMathApproxFunc = (1 << 6);
    public const int LLVMFastMathNone = 0;
    public const int LLVMFastMathAll = LLVMFastMathAllowReassoc | LLVMFastMathNoNaNs | LLVMFastMathNoInfs | LLVMFastMathNoSignedZeros | LLVMFastMathAllowReciprocal | LLVMFastMathAllowContract | LLVMFastMathApproxFunc;

    public const int LLVMGEPFlagInBounds = (1 << 0);
    public const int LLVMGEPFlagNUSW = (1 << 1);
    public const int LLVMGEPFlagNUW = (1 << 2);
    ...
    public const int LLVMDIArgListMetadataKind = 34;
    public const int LLVMDIAssignIDMetadataKind = 35;
    public const int LLVMDISubrangeTypeMetadataKind = 36;
    public const int LLVMDIFixedPointTypeMetadataKind = 37;
